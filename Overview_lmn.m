...
pos1=get(gca,'pos');
set(gca,'ColorOrder',[[0 0 1];[0 1 0];[1 0 0];[0 0 0]]);
irf_legend(gca,{'B_L','B_M','B_N'},[0.99 0.92]);
% irf_legend(gca,{'B_N'},[pos2(1)+1.15*pos2(3),pos2(2)]);
% irf_legend(gca,'a',[0.99 0.98],'color','k','fontsize',12)
i=i+1;
...
c_eval("irf_plot([lmnVi?(:,1) lmnVi?(:,2)*0],'k--', 'Linewidth',0.75);",ic); hold off;
grid off;
c_eval("set(gca,'Ylim',[fix(min([min(lmnVi?(:,4))])/10)*10-10 fix(max(lmnVi?(:,4))/10)*10+10],'fontsize',9);",ic);
%set(gca,'Ylim',[-200 400], 'ytick',[-100 0 300]);
% irf_legend(gca,'d',[0.99 0.98],'color','k','fontsize',12);
% set(gca,'ColorOrder',[[0 0 1];[0 1 0];[1 0 0];[0 0 0];[1 0 1]]);
% irf_legend(gca,{'Vi_N','Vi_M','Vi_L','|Vi|','|Vexb|'},[0.1 0.12]);
set(gca,'ColorOrder',[[0 0 1]]);
% irf_legend(gca,{'Vi_L'},[0.05 0.92]);
ylabel('Vi_L [km/s]','fontsize',12);
i=i+1;
%% Vim_lmn plot
h(i)=irf_subplot(n,1,-i);
c_eval("irf_plot([lmnVi?(:,1) lmnVi?(:,3)], 'color','g', 'Linewidth',0.75);",ic); hold on;
...
c_eval("irf_plot([lmnVi?(:,1) lmnVi?(:,2)*0],'k--', 'Linewidth',0.75);",ic); hold off;
grid off;
c_eval("set(gca,'Ylim',[fix(min([min(lmnVi?(:,3))])/10)*10-10 fix(max(lmnVi?(:,3))/10)*10+10],'fontsize',9);",ic);
%set(gca,'Ylim',[-200 400], 'ytick',[-100 0 300]);
% irf_legend(gca,'d',[0.99 0.98],'color','k','fontsize',12);
% set(gca,'ColorOrder',[[0 0 1];[0 1 0];[1 0 0];[0 0 0];[1 0 1]]);
% irf_legend(gca,{'Vi_N','Vi_M','Vi_L','|Vi|','|Vexb|'},[0.1 0.12]);
set(gca,'ColorOrder',[[0 1 0]]);
% irf_legend(gca,{'Vi_M'},[0.05 0.92]);
ylabel('Vi_M [km/s]','fontsize',12);
i=i+1;
%% Vin_lmn plot
h(i)=irf_subplot(n,1,-i);
c_eval("irf_plot([lmnVi?(:,1) lmnVi?(:,2)], 'color','r', 'Linewidth',0.75);",ic); hold on;
...
c_eval("irf_plot([lmnVi?(:,1) lmnVi?(:,2)*0],'k--', 'Linewidth',0.75);",ic); hold off;
grid off;
c_eval("set(gca,'Ylim',[fix(min([min(lmnVi?(:,2))])/10)*10-10 fix(max(lmnVi?(:,2))/10)*10+10],'fontsize',9);",ic);
%set(gca,'Ylim',[-200 400], 'ytick',[-100 0 300]);
% irf_legend(gca,'d',[0.99 0.98],'color','k','fontsize',12);
% set(gca,'ColorOrder',[[0 0 1];[0 1 0];[1 0 0];[0 0 0];[1 0 1]]);
% irf_legend(gca,{'Vi_N','Vi_M','Vi_L','|Vi|','|Vexb|'},[0.1 0.12]);
set(gca,'ColorOrder',[[1 0 0]]);
% irf_legend(gca,{'Vi_N'},[0.05 0.92]);
ylabel('Vi_N [km/s]','fontsize',12);
i=i+1;
%% momentum equation
% % % h(i)=irf_subplot(n,1,-i);

function [index,area1,area2,area3,area4]=poincare_index_and_solid_angle(B1,B2,B3,B4)
...
% c_eval('area? = abs(area?);')
% area2 = -area2;area4 = -area4;
index=(area1+area2+area3+area4)/(4*pi);

% area1=irf.solidangle(Map_sc1,Map_sc2,Map_sc3); 
% area2=irf.solidangle(Map_sc2,Map_sc3,Map_sc4);
% area3=irf.solidangle(Map_sc3,Map_sc4,Map_sc1);
% area4=irf.solidangle(Map_sc4,Map_sc1,Map_sc2);

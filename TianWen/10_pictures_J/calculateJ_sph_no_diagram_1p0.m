...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% input data (sph)
inputFile = '/Users/fwd/Desktop/10_pictures_J/T_BRsphere_za_year_15_23.mat';
load(inputFile);
...
gridNuma = 360; gridNume = 150; gridNumh = 5; 
% 若try中语句错误，则跳转到catch
try
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% input data (sph)
inputFile = 'E:\Martian\programs\2_Maven_Download\10_pictures_J/T_BRsphere_za_year_15_18_day.mat';
load(inputFile);
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% input data (sph)
inputFile = 'E:\Martian\programs\2_Maven_Download\10_pictures_J/T_BRsphere_za_year_15_18_nig.mat';
load(inputFile);

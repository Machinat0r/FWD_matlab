...
% % % d=dataobj('D:\matlab2018b\MMS\mms1\fpi\brst\l2\des-dist\2017\08\23\mms1_fpi_brst_l2_des-dist_20170823153713_v3.3.0.cdf');
% % % b=dataobj('D:\matlab2018b\MMS\mms1\fgm\brst\l2\2017\08\23\mms1_fgm_brst_l2_20170823153713_v5.100.0.cdf');
% % % tint = irf.tint('2017-08-23T15:38:20Z/2017-08-23T15:39:15Z');

% ic = 3;
% d=dataobj('/Users/fwd/Documents/MATLAB/MMS/mms3/fpi/brst/l2/des-dist/2022/08/19/mms3_fpi_brst_l2_des-dist_20220819011143_v3.4.0.cdf');
% b=dataobj('/Users/fwd/Documents/MATLAB/MMS/mms3/fgm/brst/l2/2022/08/19/mms3_fgm_brst_l2_20220819011143_v5.362.0.cdf');
% tint = irf.tint('2022-08-19T01:13:40.00Z/2022-08-19T01:14:40.00Z');

ic = 1;
c_eval("d=dataobj('/Volumes/172.17.190.41/Data/MMS/mms1/fpi/brst/l2/des-dist/2018/07/03/mms1_fpi_brst_l2_des-dist_20180703154943_v3.3.0.cdf');",ic);
% c_eval("d=dataobj('/Volumes/172.17.190.41/Data/MMS/mms1/fpi/brst/l2/des-dist/2018/07/06/mms1_fpi_brst_l2_des-dist_20180706123843_v3.3.0.cdf');",ic);

c_eval("b=dataobj('/Volumes/172.17.190.41/Data/MMS/mms1/fgm/brst/l2/2018/07/03/mms1_fgm_brst_l2_20180703154943_v5.146.0.cdf');",ic);
% c_eval("b=dataobj('/Volumes/172.17.190.41/Data/MMS/mms1/fgm/brst/l2/2018/07/06/mms1_fgm_brst_l2_20180706123843_v5.146.0.cdf');",ic);
...
%%%%%%%%%%%%%%%%%%%%%   electron  %%%%%%%%%%%%%%%%%%%% 
c_eval("diste = get_ts(d,'mms?_des_dist_brst');",ic);
c_eval("energye0= get_variable(d,'mms?_des_energy0_brst');",ic);
c_eval("energye1= get_variable(d,'mms?_des_energy1_brst');",ic);
c_eval("phie=get_ts(d,'mms?_des_phi_brst');",ic);
c_eval("thetae=get_variable(d,'mms?_des_theta_brst');",ic);
c_eval("stepTablee=get_ts(d,'mms?_des_steptable_parity_brst');",ic);
c_eval("Bxyz=get_ts(b,'mms?_fgm_b_gsm_brst_l2');",ic);
...
c_eval(['B1_gse=irf_gse2gsm(B1,-1);'],ic);
...
ylabel(h(3),{'15eV'},'fontsize',12,'Interpreter','tex');
...
ylabel(h(7),{'41eV'},'fontsize',12,'Interpreter','tex');
...
set(h(2),'yscale','lin');
set(h(2),'ytick',[45 90 135],'fontsize',12,'TickDir','in');
ylabel(h(2),{'53eV'},'fontsize',12,'Interpreter','tex');
% irf_legend(h(2),'55eV',[-0.04 0.7],'Rotation',90,'color','k','fontsize',13);
...
set(h(3),'yscale','lin');
set(h(3),'ytick',[45 90 135],'fontsize',12,'TickDir','in');
ylabel(h(3),{'68eV'},'fontsize',12,'Interpreter','tex');
% irf_legend(h(3),'66eV',[-0.04 0.7],'Rotation',90,'color','k','fontsize',13);
set(h(3),'fontsize',13);
...
set(h(4),'yscale','lin');
set(h(4),'ytick',[45 90 135],'fontsize',12,'TickDir','in');
ylabel(h(4),{'87eV'},'fontsize',12,'Interpreter','tex');
% irf_legend(h(4),'85eV',[-0.04 0.7],'Rotation',90,'color','k','fontsize',13);
set(h(4),'fontsize',13);
...
set(h(5),'yscale','lin');
set(h(5),'ytick',[45 90 135],'fontsize',12,'TickDir','in');
ylabel(h(5),{'111eV'},'fontsize',12,'Interpreter','tex');
% irf_legend(h(5),'109eV',[-0.04 0.7],'Rotation',90,'color','k','fontsize',13);
set(h(5),'fontsize',13);
...
set(h(6),'yscale','lin');
set(h(6),'ytick',[45 90 135],'fontsize',12,'TickDir','in');
ylabel(h(6),{'142eV'},'fontsize',12,'Interpreter','tex');
% irf_legend(h(6),'140eV',[-0.04 0.7],'Rotation',90,'color','k','fontsize',13);
set(h(6),'fontsize',13);
...
set(h(7),'yscale','lin');
set(h(7),'ytick',[45 90 135],'fontsize',12,'TickDir','in');
ylabel(h(7),{'183eV'},'fontsize',12,'Interpreter','tex');
% irf_legend(h(7),'179eV',[-0.04 0.7],'Rotation',90,'color','k','fontsize',13);
set(h(7),'fontsize',13);
...
% ylabel(h(8),{'234eV'},'fontsize',12,'Interpreter','tex');
% % irf_legend(h(4),'85eV',[-0.04 0.7],'Rotation',90,'color','k','fontsize',13);
% set(h(8),'fontsize',13);
specrec_p_ehigh.p_label={' ','keV/(cm^2 s sr keV)'};
...
h(i_subplot)=irf_subplot(n_subplots,1,-i_subplot);i_subplot=i_subplot+1;
% h(2)=irf_panel('epad13');
% set(h(2),'pos',[0.17 0.875 0.73 0.057]);
irf_spectrogram(h(2),specepad13,'log','donotfitcolorbarlabel');
...
set(h(2),'yscale','lin');
set(h(2),'ytick',[45 90 135],'fontsize',12,'TickDir','in');
ylabel(h(2),{'234eV'},'fontsize',12,'Interpreter','tex');
% irf_legend(h(2),'55eV',[-0.04 0.7],'Rotation',90,'color','k','fontsize',13);

h(i_subplot)=irf_subplot(n_subplots,1,-i_subplot);i_subplot=i_subplot+1;
% h(3)=irf_panel('epad14');
% set(h(3),'pos',[0.17 0.81 0.73 0.057]);
irf_spectrogram(h(3),specepad14,'log','donotfitcolorbarlabel');
...
set(h(3),'yscale','lin');
set(h(3),'ytick',[45 90 135],'fontsize',12,'TickDir','in');
ylabel(h(3),{'300eV'},'fontsize',12,'Interpreter','tex');
% irf_legend(h(3),'66eV',[-0.04 0.7],'Rotation',90,'color','k','fontsize',13);
set(h(3),'fontsize',13);


h(i_subplot)=irf_subplot(n_subplots,1,-i_subplot);i_subplot=i_subplot+1;
% h(4)=irf_panel('epad15');
% set(h(4),'pos',[0.17 0.745 0.73 0.057]);
irf_spectrogram(h(4),specepad15,'log','donotfitcolorbarlabel');
...
set(h(4),'yscale','lin');
set(h(4),'ytick',[45 90 135],'fontsize',12,'TickDir','in');
ylabel(h(4),{'385eV'},'fontsize',12,'Interpreter','tex');
% irf_legend(h(4),'85eV',[-0.04 0.7],'Rotation',90,'color','k','fontsize',13);
set(h(4),'fontsize',13);


h(i_subplot)=irf_subplot(n_subplots,1,-i_subplot);i_subplot=i_subplot+1;
% h(5)=irf_panel('epad16');
% set(h(5),'pos',[0.17 0.68 0.73 0.057]);
irf_spectrogram(h(5),specepad16,'log','donotfitcolorbarlabel');
...
set(h(5),'yscale','lin');
set(h(5),'ytick',[45 90 135],'fontsize',12,'TickDir','in');
ylabel(h(5),{'494eV'},'fontsize',12,'Interpreter','tex');
% irf_legend(h(5),'109eV',[-0.04 0.7],'Rotation',90,'color','k','fontsize',13);
set(h(5),'fontsize',13);


h(i_subplot)=irf_subplot(n_subplots,1,-i_subplot);i_subplot=i_subplot+1;
% h(6)=irf_panel('epad17');
% set(h(6),'pos',[0.17 0.615 0.73 0.057]);
irf_spectrogram(h(6),specepad17,'log','donotfitcolorbarlabel');
...
set(h(6),'yscale','lin');
set(h(6),'ytick',[45 90 135],'fontsize',12,'TickDir','in');
ylabel(h(6),{'633eV'},'fontsize',12,'Interpreter','tex');
% irf_legend(h(6),'140eV',[-0.04 0.7],'Rotation',90,'color','k','fontsize',13);
set(h(6),'fontsize',13);


h(i_subplot)=irf_subplot(n_subplots,1,-i_subplot);i_subplot=i_subplot+1;
% h(7)=irf_panel('epad18');
% set(h(7),'pos',[0.17 0.55 0.73 0.057]);
irf_spectrogram(h(7),specepad18,'log','donotfitcolorbarlabel');
...
set(h(7),'yscale','lin');
set(h(7),'ytick',[45 90 135],'fontsize',12,'TickDir','in');
ylabel(h(7),{'812eV'},'fontsize',12,'Interpreter','tex');
% irf_legend(h(7),'179eV',[-0.04 0.7],'Rotation',90,'color','k','fontsize',13);
set(h(7),'fontsize',13);
...
% set(h(2),'pos',[0.17 0.875 0.73 0.057]);
irf_spectrogram(h(2),specepad19,'log','donotfitcolorbarlabel');
...
set(h(2),'yscale','lin');
set(h(2),'ytick',[45 90 135],'fontsize',12,'TickDir','in');
ylabel(h(2),{'1041eV'},'fontsize',12,'Interpreter','tex');
% irf_legend(h(2),'55eV',[-0.04 0.7],'Rotation',90,'color','k','fontsize',13);

h(i_subplot)=irf_subplot(n_subplots,1,-i_subplot);i_subplot=i_subplot+1;
% h(3)=irf_panel('epad20');
% set(h(3),'pos',[0.17 0.81 0.73 0.057]);
irf_spectrogram(h(3),specepad20,'log','donotfitcolorbarlabel');
...
set(h(3),'yscale','lin');
set(h(3),'ytick',[45 90 135],'fontsize',12,'TickDir','in');
ylabel(h(3),{'1336eV'},'fontsize',12,'Interpreter','tex');
% irf_legend(h(3),'66eV',[-0.04 0.7],'Rotation',90,'color','k','fontsize',13);
set(h(3),'fontsize',13);
...
% set(h(4),'pos',[0.17 0.745 0.73 0.057]);
irf_spectrogram(h(4),specepad21,'log','donotfitcolorbarlabel');
...
set(h(4),'yscale','lin');
set(h(4),'ytick',[45 90 135],'fontsize',12,'TickDir','in');
ylabel(h(4),{'1713eV'},'fontsize',12,'Interpreter','tex');
% irf_legend(h(4),'85eV',[-0.04 0.7],'Rotation',90,'color','k','fontsize',13);
set(h(4),'fontsize',13);
...
% set(h(5),'pos',[0.17 0.68 0.73 0.057]);
irf_spectrogram(h(5),specepad22,'log','donotfitcolorbarlabel');
...
set(h(5),'yscale','lin');
set(h(5),'ytick',[45 90 135],'fontsize',12,'TickDir','in');
ylabel(h(5),{'2197eV'},'fontsize',12,'Interpreter','tex');
% irf_legend(h(5),'109eV',[-0.04 0.7],'Rotation',90,'color','k','fontsize',13);
set(h(5),'fontsize',13);
...
% set(h(6),'pos',[0.17 0.615 0.73 0.057]);
irf_spectrogram(h(6),specepad23,'log','donotfitcolorbarlabel');
...
set(h(6),'yscale','lin');
set(h(6),'ytick',[45 90 135],'fontsize',12,'TickDir','in');
ylabel(h(6),{'2817eV'},'fontsize',12,'Interpreter','tex');
% irf_legend(h(6),'140eV',[-0.04 0.7],'Rotation',90,'color','k','fontsize',13);
set(h(6),'fontsize',13);
...
% set(h(7),'pos',[0.17 0.55 0.73 0.057]);
irf_spectrogram(h(7),specepad24,'log','donotfitcolorbarlabel');
...
set(h(7),'yscale','lin');
set(h(7),'ytick',[45 90 135],'fontsize',12,'TickDir','in');
ylabel(h(7),{'3612eV'},'fontsize',12,'Interpreter','tex');
% irf_legend(h(7),'179eV',[-0.04 0.7],'Rotation',90,'color','k','fontsize',13);
set(h(7),'fontsize',13);
...
% h(2)=irf_panel('epad19');
% set(h(2),'pos',[0.17 0.875 0.73 0.057]);
irf_spectrogram(h(2),specepad25,'log','donotfitcolorbarlabel');
...
set(h(2),'yscale','lin');
set(h(2),'ytick',[45 90 135],'fontsize',12,'TickDir','in');
ylabel(h(2),{'4633eV'},'fontsize',12,'Interpreter','tex');
% irf_legend(h(2),'55eV',[-0.04 0.7],'Rotation',90,'color','k','fontsize',13);

h(i_subplot)=irf_subplot(n_subplots,1,-i_subplot);i_subplot=i_subplot+1;
% h(3)=irf_panel('epad20');
% set(h(3),'pos',[0.17 0.81 0.73 0.057]);
irf_spectrogram(h(3),specepad26,'log','donotfitcolorbarlabel');
...
set(h(3),'yscale','lin');
set(h(3),'ytick',[45 90 135],'fontsize',12,'TickDir','in');
ylabel(h(3),{'5941eV'},'fontsize',12,'Interpreter','tex');
% irf_legend(h(3),'66eV',[-0.04 0.7],'Rotation',90,'color','k','fontsize',13);
set(h(3),'fontsize',13);
...
% h(4)=irf_panel('epad21');
% set(h(4),'pos',[0.17 0.745 0.73 0.057]);
irf_spectrogram(h(4),specepad27,'log','donotfitcolorbarlabel');
...
set(h(4),'yscale','lin');
set(h(4),'ytick',[45 90 135],'fontsize',12,'TickDir','in');
ylabel(h(4),{'7619eV'},'fontsize',12,'Interpreter','tex');
% irf_legend(h(4),'85eV',[-0.04 0.7],'Rotation',90,'color','k','fontsize',13);
set(h(4),'fontsize',13);
...
% h(5)=irf_panel('epad22');
% set(h(5),'pos',[0.17 0.68 0.73 0.057]);
irf_spectrogram(h(5),specepad28,'log','donotfitcolorbarlabel');
% 
% hold on;
% irf_plot([alpha(:,1) alpha(:,2)],'k--', 'Linewidth',0.75); hold on;
% irf_plot([alpha(:,1) alpha(:,3)],'k--', 'Linewidth',0.75); hold off;
...
set(h(5),'yscale','lin');
set(h(5),'ytick',[45 90 135],'fontsize',12,'TickDir','in');
ylabel(h(5),{'9771eV'},'fontsize',12,'Interpreter','tex');
% irf_legend(h(5),'109eV',[-0.04 0.7],'Rotation',90,'color','k','fontsize',13);
set(h(5),'fontsize',13);
...
% h(6)=irf_panel('epad123');
% set(h(6),'pos',[0.17 0.615 0.73 0.057]);
irf_spectrogram(h(6),specepad29,'log','donotfitcolorbarlabel');
...
set(h(6),'yscale','lin');
set(h(6),'ytick',[45 90 135],'fontsize',12,'TickDir','in');
ylabel(h(6),{'12531eV'},'fontsize',12,'Interpreter','tex');
% irf_legend(h(6),'140eV',[-0.04 0.7],'Rotation',90,'color','k','fontsize',13);
set(h(6),'fontsize',13);
...
% h(7)=irf_panel('epad24');
% set(h(7),'pos',[0.17 0.55 0.73 0.057]);
irf_spectrogram(h(7),specepad30,'log','donotfitcolorbarlabel');
...
set(h(7),'yscale','lin');
set(h(7),'ytick',[45 90 135],'fontsize',12,'TickDir','in');
ylabel(h(7),{'16069eV'},'fontsize',12,'Interpreter','tex');
% irf_legend(h(7),'179eV',[-0.04 0.7],'Rotation',90,'color','k','fontsize',13);
set(h(7),'fontsize',13);
...
set(h(2),'yscale','lin');
set(h(2),'ytick',[45 90 135],'fontsize',12,'TickDir','in');
ylabel(h(2),{'22039eV'},'fontsize',12,'Interpreter','tex');
% irf_legend(h(2),'55eV',[-0.04 0.7],'Rotation',90,'color','k','fontsize',13);
...
set(h(3),'yscale','lin');
set(h(3),'ytick',[45 90 135],'fontsize',12,'TickDir','in');
ylabel(h(3),{'28010eV'},'fontsize',12,'Interpreter','tex');
% irf_legend(h(3),'66eV',[-0.04 0.7],'Rotation',90,'color','k','fontsize',13);
set(h(3),'fontsize',13);
...
set(h(5),'yscale','lin');
set(h(5),'ytick',[45 90 135],'fontsize',12,'TickDir','in');
% ylabel(h(5),{'10219eV'},'fontsize',12,'Interpreter','tex');
% irf_legend(h(5),'109eV',[-0.04 0.7],'Rotation',90,'color','k','fontsize',13);
set(h(5),'fontsize',13);
...
set(h(6),'yscale','lin');
set(h(6),'ytick',[45 90 135],'fontsize',12,'TickDir','in');
% ylabel(h(6),{'13105eV'},'fontsize',12,'Interpreter','tex');
% irf_legend(h(6),'140eV',[-0.04 0.7],'Rotation',90,'color','k','fontsize',13);
set(h(6),'fontsize',13);
...
set(h(7),'yscale','lin');
set(h(7),'ytick',[45 90 135],'fontsize',12,'TickDir','in');
% ylabel(h(7),{'16805eV'},'fontsize',12,'Interpreter','tex');
% irf_legend(h(7),'179eV',[-0.04 0.7],'Rotation',90,'color','k','fontsize',13);
set(h(7),'fontsize',13);

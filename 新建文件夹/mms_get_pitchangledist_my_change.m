function [paddist,theta,energy,tint] = mms_get_pitchangledist_my_change(varargin) 
...
lengthphi = 32;
lengththeta = 16;
% anglevec = [6:12:180]; % Default pitch angles. 15 degree angle widths
anglevec = [5.6250000	16.875000	28.125000	39.375000	50.625000	61.875000	73.125000	84.375000	95.625000	106.87500	118.12500	129.37500	140.62500	151.87500	163.12500	174.37500];
...
if length(dangle)==1, dangle=dangle+zeros(length(anglevec)); end

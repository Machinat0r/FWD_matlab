...
TT = '2021-08-22T06:39:55.00Z/2021-08-22T06:42:45.00';
...
if flag == 1
c_eval(['fpiFilee1 = dataobj(','''','D:\MMS\mms1\fpi\brst\l2\des-moms\2021\08\22\mms1_fpi_brst_l2_des-moms_20210822063953_v3.4.0.cdf.','''',');'],ic);
...
c_eval(['fpiFilee2 = dataobj(','''','D:\MMS\mms1\fpi\brst\l2\des-moms\2021\08\22\mms1_fpi_brst_l2_des-moms_20210822064213_v3.4.0.cdf','''',');'],ic);
...
% % % set(gca,'Ylim',[-1 4], 'ytick',[-0.5 0 0.5]);
% % % pos1=get(gca,'pos');
% % % set(gca,'ColorOrder',[[0 0 1];[0 1 0];[1 0 0];[0 0 0]]);
...
rmdir(TempDir,'s'); 
figname = 'C:\Users\fwd\Desktop\Ti~mor~\M\Electron Fermi acceleration by flow vortex\20210822\overview';

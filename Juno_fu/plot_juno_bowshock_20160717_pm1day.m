%% Juno bow-shock crossing on 2016-07-17: one day before and after
% This is the Hospodarsky et al. (2017) 15:33 UTC outbound crossing.
% The displayed interval is exactly shock time +/- 1 day.
%
% Science-data rule:
...
manifestFile = fullfile(outputDir, ...
    'juno_bowshock_20160717_1533_pm1day_manifest.csv');
...
function events = defineEvents(root)
    ...
    events = makeEvent( ...
        'orbit0_20160717_pm1day',shockTime+[-1 1],shockTime, ...
        720,30,'out', ...
        'Hospodarsky et al. (2017)', ...
        '10.1002/2017GL073177', ...
        waveFiles,'MAG_PC',magFiles, ...
        'juno_bowshock_20160717_1533_pm1day_hospodarsky2017');
end
...
function fig = createEventFigure(event,magTime,magB,magTotal, ...
    ...
    plotSpectrum(axWave,waveTime,wavePsd,frequencyHz, ...
        receiverBoundaries,[1e-14 1e-11]);

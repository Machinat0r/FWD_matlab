...
ic=1;
Tintr = irf.tint('2019-08-05T16:24:00Z/2019-08-05T16:25:00Z');
...
Bxyz=mms.get_data('B_gsm_brst',Tintr,ic);
...
tint1=irf.tint('2019-08-05T16:24:30Z/2019-08-05T16:24:32Z');
...
tint2=irf.tint('2019-08-05T16:24:32Z/2019-08-05T16:24:34Z');
...
tint3=irf.tint('2019-08-05T16:24:34Z/2019-08-05T16:24:36Z');
...
tint4=irf.tint('2019-08-05T16:24:36Z/2019-08-05T16:24:38Z');
...
set(fn,'Position',[100 20 1000 600])
    ...
    h(2)=axes('position',[0.28 0.19 0.18 0.65]); 
    h(3)=axes('position',[0.50 0.19 0.18 0.65]); 
...
c_eval('plot(h(1),thetapad,paddist1(?,:),''color'',jetcolor(8*?,:));',5:32);
% hold(h(1),'on');
...
ylabel(h(1),'f_e (s^3 km^{-6})','FontSize',15);
xlabel(h(1),'\theta (deg.)','FontSize',15)
set(h(1),'yscale','log');
set(h(1),'Ylim',[1e-4 2*1e3],'FontSize',12);
...
% c_eval('plot(h(2),j,f?,''color'',jetcolor(?+2,:));',[2:18]);
% paddist_1=paddist1(13:32,:);
c_eval('plot(h(2),thetapad,paddist2(?,:),''color'',jetcolor(8*?,:));',5:32);
% hold(h(1),'on');
...
xlabel(h(2),'\theta (deg.)','FontSize',15)
set(h(2),'yscale','log');
set(h(2),'Ylim',[1e-4 2*1e3],'FontSize',12);
...
c_eval('plot(h(3),thetapad,paddist3(?,:),''color'',jetcolor(8*?,:));',5:32);
...
xlabel(h(3),'\theta (deg.)','FontSize',15)
set(h(3),'yscale','log');
set(h(3),'Ylim',[1e-4 2*1e3],'FontSize',12);
...
% c_eval('plot(h(2),j,f?,''color'',jetcolor(?+2,:));',[2:18]);
% paddist_1=paddist1(13:32,:);
c_eval('plot(h(4),thetapad,paddist4(?,:),''color'',jetcolor(8*?,:));',5:32);
% for i=1;32,
% plot(h(2),thetapad,paddist(i,:),'color',jetcolor(2*i,:) );
% end
% c_eval('plot(h(2),thetapad,paddist(?,:));',[1:32]);
...
for i=1:length(energypad(5:32))
    a=roundn(energypad(1,5:32)/1000,-3);
c_eval('irf_legend(h(4),''? keV'',[1.02 1-i*0.033],''color'',jetcolor(8*i,:));',a(i));
end


% ylabel(h(4),'f_e (s^3 km^{-6})');
xlabel(h(4),'\theta (deg.)','FontSize',15)
set(h(4),'yscale','log');
set(h(4),'Ylim',[1e-4 2*1e3],'FontSize',12);

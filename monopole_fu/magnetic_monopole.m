...
% Tsta = '2003-12-17T21:57:00.000Z';
% Tend = '2003-12-17T21:58:00.000Z';
% % % % % Tsta = '2004-01-17T19:31:00.000Z';
% % % % % Tend = '2004-01-17T19:32:00.000Z';
Tsta = '2003-08-17T16:40:00.000Z';
Tend = '2003-08-17T16:42:00.000Z';


% Tsta='2004-01-01T11:10:00.00Z';
% Tend='2004-01-01T11:11:00.00Z';
% Tsta='2004-01-03T15:53:00.00Z';
...
% Tsta2 = '2003-12-17T21:57:14.000Z';
% Tend2 = '2003-12-17T21:57:15.000Z';
% % % % % Tsta2 = '2004-01-17T19:31:44.900Z';
% % % % % Tend2 = '2004-01-17T19:31:46.500Z';
Tsta2 = '2003-08-17T16:41:10.000Z';
Tend2 = '2003-08-17T16:41:20.000Z';
...
% Tend2='2004-05-30T13:09:31.00Z';
% Tsta2='2002-05-15T09:39:33.500Z';
% Tend2='2002-05-15T09:39:34.500Z';
...
% c_eval("set(gca,'Ylim',[min([min(B?_gse(:,2))])-100 max([max(B?_gse(:,2))])+100]);",ic);
% set(gca,'Ylim',[-8 11], 'ytick',[-5 0 5 10],'fontsize',9);
pos1=get(gca,'pos');
set(gca,'ColorOrder',[[0 0 0];[1 0 0];[0 1 0];[0 0 1]]);
% irf_legend(gca,{'C1','C2','C3','C4'},[0.97 0.92]);
...
% set(gca,'Ylim',[-22 22], 'ytick',[-20 -10 0 10 20],'fontsize',9);
% pos1=get(gca,'pos');
set(gca,'ColorOrder',[[0 0 0];[1 0 0];[0 1 0];[0 0 1]]);
% irf_legend(gca,{'C1','C2','C3','C4'},[0.97 0.92]);
...
set(gca,'Ylim',[min([min(B1_gse(:,4)) min(B2_gse(:,4)) min(B3_gse(:,4)) min(B4_gse(:,4))])-5 ...
    max([max(B1_gse(:,4)) max(B2_gse(:,4)) max(B3_gse(:,4)) max(B4_gse(:,4))])+10]);
% set(gca,'Ylim',[-22 22], 'ytick',[-20 -10 0 10 20],'fontsize',9);
% pos1=get(gca,'pos');
set(gca,'ColorOrder',[[0 0 0];[1 0 0];[0 1 0];[0 0 1]]);
% irf_legend(gca,{'C1','C2','C3','C4'},[0.97 0.92]);
...
irf_plot([divB(:,1) 0*divB(:,2)],'k--', 'Linewidth',0.75); hold on;

% c_eval("irf_plot([eigVal_err_v2(:,1) 0*eigVal_err_v2(:,4)],'k--', 'Linewidth',0.75);",ic); hold off;
grid off;
c_eval("set(gca,'Ylim',[min(divB(:,2))-0.005 max(divB(:,2)+0.005)],'fontsize',9);",ic);
% set(gca,'Ylim',[0 0.2], 'ytick',[0 0.1 0.2],'fontsize',9);
pos1=get(gca,'pos');
set(gca,'ColorOrder',[[0 0 1];[1 0 0]]);
% irf_legend(gca,{'B_x','B_z'},[0.97 0.92]);
...
colormap(jet)
% figname = 'C:\Users\fwd\Desktop\Ti~mor~\M\magnetic_monopole\Figure\new\Figure3\error\0922\std&mean_paras_1230';
% print(gcf, '-dbmp', [figname '.bmp']);

%% Index id
% length(find(Locerror<50 & Qerror<1000))
% tempidx_B = find(Locerror<=50 & Qerror<1000);
...
set(gcf,'render','painters');
set(gcf,'paperpositionmode','auto')
% figname = ['C:\Users\fwd\Desktop\Ti~mor~\M\magnetic_monopole\error-search\Cluster\temp\' datestr(datenum(1970,1,1,0,0,0)+B1(tempidx_B1,1)/86400,'yymmdd-HHMMSS')];

...
try
    ...
    flag_m = zeros(length(PI),1);
    tempidx_B1 = zeros(length(PI),1);
    time_flagm = zeros(length(PI),1);
    flag_ang = zeros(length(PI),1);
    time_flag = zeros(length(PI),1);

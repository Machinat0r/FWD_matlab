...
[n,theta,t_wavelet,freq_wavelet] = svd_EM(Bxyz_brst1, E0, Bscm1, Exyz_brst1, [fmin,fmax]);
%% wavelet
% nT^2/Hz
Bsum = irf_wavelet(Bscm1,'returnpower',1,'cutedge',0,'nf',100,'f',[fmin fmax],'fs',8192);
Bwavelet = Bsum.p{1}+Bsum.p{2}+Bsum.p{3};
% (mV/m)^2/Hz
Esum = irf_wavelet(Exyz_brst1,'returnpower',1,'cutedge',0,'nf',100,'f',[fmin fmax],'fs',8192);

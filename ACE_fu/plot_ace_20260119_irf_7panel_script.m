%% ACE 2026-01-19 event overview, IRF-MATLAB 7-panel script
...
fprintf('SWE points : %d samples in 12:00-00:00, %d valid Vp/Ti samples\n', ...
...
fig = gcf;
set(fig, 'Color', 'w', 'Name', 'ACE 2026-01-19 IRF 7-panel', ...
...
irf_legend(h(7), {'H^+ 46-68 keV','H^+ 67-115 keV','H^+ 115-195 keV','H^+ 193-321 keV', ...
...
irf_zoom(h, 'x', tint);
irf_timeaxis(h, 'date');
xlabel(h(end), '2026-01-19/20 UTC');
...
% outFig = fullfile(baseDir, 'ace_20260119_overview_irf.fig');
% outPng = fullfile(baseDir, 'ace_20260119_overview_irf.png');
% outPdf = fullfile(baseDir, 'ace_20260119_overview_irf.pdf');

%% ACE 2003 Halloween storm magnetic field and EPAM overview
...
mfiCsv = fullfile(cacheDir, 'AC_H3_MFI_20031029T0000_20031031T0000_Magnitude_BGSEc.csv');
mfiMat = fullfile(cacheDir, 'AC_H3_MFI_20031029T0000_20031031T0000_Magnitude_BGSEc.mat');
mfiUrl = ['https://cdaweb.gsfc.nasa.gov/hapi/data?id=AC_H3_MFI', ...
    '&parameters=Magnitude,BGSEc', ...
    '&time.min=2003-10-29T00:00:00Z', ...
    '&time.max=2003-10-31T00:00:00Z&format=csv'];

epmCsv = fullfile(cacheDir, ...
    'AC_H3_EPM_20031029T0000_20031031T0000_all_telescopes.csv');
epmMat = fullfile(cacheDir, ...
    'AC_H3_EPM_20031029T0000_20031031T0000_all_telescopes.mat');
...
fprintf('\nValid EPAM samples in the 2003 Halloween interval:\n');
...
fig = gcf;
set(fig, 'Color', 'w', 'Name', 'ACE 2003 Halloween EPAM six-panel', ...
...
text(h(2), 0.985, 0.73, 'P_1 invalid; P_{2-6} partial after noise onset', ...
...
xlabel(h(6), '2003-10-29 to 31 UTC');
...
outFig = fullfile(baseDir, 'ace_20031029_31_epam_spectrogram.fig');
outPng = fullfile(baseDir, 'ace_20031029_31_epam_spectrogram.png');
outPdf = fullfile(baseDir, 'ace_20031029_31_epam_spectrogram.pdf');
savefig(fig, outFig);
...
figLine = gcf;
set(figLine, 'Color', 'w', 'Name', 'ACE 2003 Halloween EPAM line plots', ...
...
text(hLine(2), 0.10, 0.60, 'P_1 invalid; P_{2-6} partial', ...
...
xlabel(hLine(6), '2003-10-29 to 31 UTC');
...
set(gcf,'paperpositionmode','auto')
lineFigFile = fullfile(baseDir, 'ace_20031029_31_epam_lines.fig');
linePngFile = fullfile(baseDir, 'ace_20031029_31_epam_lines.png');
linePdfFile = fullfile(baseDir, 'ace_20031029_31_epam_lines.pdf');

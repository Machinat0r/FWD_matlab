...
hold(h(1),'off');
ylabel(h(1),{'\delta B','(nT)'},'Interpreter','tex');
set(h(1),'ylim',[-7 7],'ytick',[-5:5:5]);
irf_legend(h(1),{'L   ','M   ','N   '},[0.98 0.03],'fontsize',12)
...
irf_legend(h(2),{'L   ','M   ','N   '},[0.98 0.03],'fontsize',12)
...
hold(h(5),'on');
% irf_plot(h(3),Ni1,'Linewidth',lnwid,'color','b');
irf_plot(h(5),[B2(:,1),matParTe2(:,2)],'Linewidth',lnwid,'color','k');
irf_plot(h(5),[B2(:,1),matPerTe2(:,2)],'Linewidth',lnwid,'color','b');
hold(h(5),'off');
...
irf_legend(h(6),{'L   ','M   ','N   '},[0.98 0.03],'fontsize',12)

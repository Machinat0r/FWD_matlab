...
x = 0:39:1000;
x=x';
y = VeS_LMN2(71:96,1)*0;
meanL=mean(VeS_LMN2(71:96,2));
meanM=mean(VeS_LMN2(71:96,3));
meanN=mean(VeS_LMN2(71:96,4));
L_raw = VeS_LMN2(71:96,2);
M_raw = VeS_LMN2(71:96,3);
N_raw = VeS_LMN2(71:96,4);
count=length(L_raw);
L=zeros(count,1);
M=zeros(count,1);
N=zeros(count,1);

...
%
% $Id: irf_subplot.m,v 1.1 2005/02/15 13:17:00 yuri Exp $

%   Copyright 1984-2000 The MathWorks, Inc. 
%   $Revision: 1.1 $  $Date: 2005/02/15 13:17:00 $
...
elseif(isempty(position))
    if (min(thisPlot) < 1)
        ...
        if exist('flag_tight'),
           PERC_OFFSET_B=0.2*PERC_OFFSET_L;PERC_OFFSET_T=0.2*PERC_OFFSET_R;
           PERC_OFFSET_L=0.2*PERC_OFFSET_L;PERC_OFFSET_R=0.2*PERC_OFFSET_R;
        end  % AV
        if nrows > 2

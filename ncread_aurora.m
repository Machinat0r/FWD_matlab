...
clear;clc;close all
% 18.0969
% file_path = '/Users/fwd/Documents/Ti~mor~/M/Sandglass/Nat/submission/Figures/aurora/dmspf17_ssusi_edr-aurora_2018184T160421-2018184T174550-REV60172_vA8.2.0r000.nc';
file_path = '/Users/fwd/Documents/Ti~mor~/M/Sandglass/Nat/submission/Figures/aurora/dmspf18_ssusi_edr-aurora_2018184T155956-2018184T174147-REV44905_vA8.2.0r000.nc';%north 1622
% file_path = '/Users/fwd/Documents/Ti~mor~/M/Sandglass/Nat/submission/Figures/aurora/dmspf18_ssusi_edr-aurora_2018184T141800-2018184T155951-REV44904_vA8.2.0r000.nc';%
% file_path = 'C:\Users\pc\Documents\Timor\Recovery-Work-Sandglass\Nat\submission\Figures\aurora/PS.APL_V0105S027CB0006_SC.U_DI.A_GP.F18-SSUSI_PA.APL-EDR-AURORA_DD.20190805_SN.027894-00_DF.NC';%1808
...
% file_path = 'C:\Users\pc\Documents\Timor\Recovery-Work-Sandglass\Nat\submission\Figures\aurora/dmspf17_ssusi_edr-aurora_2019217T150651-2019217T164842-REV65793_vA8.2.0r000.nc';%%1600
% file_path = 'C:\Users\pc\Documents\Timor\Recovery-Work-Sandglass\Nat\submission\Figures\aurora/dmspf18_ssusi_edr-aurora_2019217T153253-2019217T171445-REV27893_vA8.2.0r000.nc'; %%1624
% file_path = 'C:\Users\pc\Documents\Timor\Recovery-Work-Sandglass\Nat\submission\Figures\aurora/dmspf17_ssusi_edr-aurora_2019217T164847-2019217T182424-REV65794_vA8.2.0r000.nc';%%1800
...
% Energy_flux_south_data = ENERGY_FLUX_NORTH_MAP.data;
...
tt(tt==0) = nan;
tt_0 = ones(size(tt));
tt = datetime(tt_0*2018,tt_0*8,tt_0*3,floor(tt),floor(100*(tt-floor(tt))),floor(100*(100*tt-floor(100*tt))));
lon_SOUTH_mesh(lon_SOUTH_mesh==0) = nan;
lon_NORTH_mesh(lon_NORTH_mesh==0) = nan;
mlt = nan*zeros(size(tt));
for row = 1:size(tt,1)
    for pan = 1:size(tt,2)
        [mlt(row,pan),~,~] = magneticLocalTime(tt(row,pan),lon_NORTH_mesh(row,pan));
    end
end
...
figure;
polarscatter(theta(:), rho(:), 15, log10(abs(ARC_NORTH_data(:))), 'filled'); hold on;
...
% polarscatter(-71.7*pi/180,90-73.98,150,'w','pentagram','filled')
ax=gca;

...
%读取四颗卫星磁场数据列表
ic=1:4;
c_eval('fileFolder?=fullfile(''F:\MMS_FGMdata\20190720_0810\combined_131603\mms?'');',ic);
...
for i=1:filesize
    % 读取数据
    ic=1:4;
    c_eval('route?=''F:\MMS_FGMdata\20190720_0810\combined_131603\mms?\'';',ic);
...
xlswrite('F:\MMS_FGMdata\eventlist',eventlist);
t_end=clock;
etime(t_end,t_start)
...
figname=['Events_B' '_' Tstautc(1:4) Tstautc(6:7) Tstautc(9:10) '-' Tstautc(12:13) ...
